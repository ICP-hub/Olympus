...
do
    ...
    dfx canister call $CANISTER add_announcement "($PROJECT_DATA)" --network ic
...
echo $(dfx --identity ic_admin canister call $CANISTER add_project_to_spotlight '('$project1')' --network ic)
echo $(dfx --identity ic_admin canister call $CANISTER add_project_to_spotlight '('$project2')' --network ic)
echo $(dfx --identity ic_admin canister call $CANISTER add_project_to_spotlight '('$project3')' --network ic)
echo $(dfx --identity ic_admin canister call $CANISTER add_project_to_spotlight '('$project4')' --network ic)
echo $(dfx --identity ic_admin canister call $CANISTER add_project_to_spotlight '('$project5')' --network ic)
