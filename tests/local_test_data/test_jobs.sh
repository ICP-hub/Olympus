...
job_data[0]='record { title = "DSCVR Frontend Integration on Internet Computer"; description = "DSCVR is a decentralized borrowing protocol that allows users to draw interest-free loans against Ether used as collateral. DSCVR now has a fully decentralized, immutable frontend hosted on the Internet Computer."; category = "Job"; link = "https://dscvr.one/"; project_id = '${project1}'; location = "Remote";}'
...
job_data[2]='record { title = "Distrikt - Transactions with Unparalleled Isolation"; description = "Self-custody made simple and secure. Turn a spare smartphone into a cold wallet that can store a plethora of tokens including ICP and ckBTC. Using Distrikt, you can stake ICP directly on the NNS and participate in governance."; category = "Job"; link = "https://distrikt.app/"; project_id = '${project3}'; location = "Bangalore";}'
