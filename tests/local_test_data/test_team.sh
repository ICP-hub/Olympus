...
user13=$(dfx --identity user13 canister call $CANISTER get_member_id '()' | sed 's/[()]//g')
user14=$(dfx --identity user14 canister call $CANISTER get_member_id '()' | sed 's/[()]//g')
user15=$(dfx --identity user15 canister call $CANISTER get_member_id '()' | sed 's/[()]//g')
user16=$(dfx --identity user16 canister call $CANISTER get_member_id '()' | sed 's/[()]//g')
user17=$(dfx --identity user17 canister call $CANISTER get_member_id '()' | sed 's/[()]//g')
user18=$(dfx --identity user18 canister call $CANISTER get_member_id '()' | sed 's/[()]//g')
user19=$(dfx --identity user19 canister call $CANISTER get_member_id '()' | sed 's/[()]//g')
user20=$(dfx --identity user20 canister call $CANISTER get_member_id '()' | sed 's/[()]//g')
user21=$(dfx --identity user21 canister call $CANISTER get_member_id '()' | sed 's/[()]//g')
user22=$(dfx --identity user22 canister call $CANISTER get_member_id '()' | sed 's/[()]//g')
user23=$(dfx --identity user23 canister call $CANISTER get_member_id '()' | sed 's/[()]//g')
user24=$(dfx --identity user24 canister call $CANISTER get_member_id '()' | sed 's/[()]//g')
user25=$(dfx --identity user25 canister call $CANISTER get_member_id '()' | sed 's/[()]//g')

echo $user13

echo $(dfx --identity user1 canister call $CANISTER update_team_member '('$project1', '$user13')')
echo $(dfx --identity user1 canister call $CANISTER update_team_member '('$project1', '$user14')')
echo $(dfx --identity user2 canister call $CANISTER update_team_member '('$project2', '$user15')')
echo $(dfx --identity user2 canister call $CANISTER update_team_member '('$project2', '$user16')')
echo $(dfx --identity user3 canister call $CANISTER update_team_member '('$project3', '$user17')')
echo $(dfx --identity user4 canister call $CANISTER update_team_member '('$project4', '$user18')')
echo $(dfx --identity user5 canister call $CANISTER update_team_member '('$project5', '$user19')')
echo $(dfx --identity user6 canister call $CANISTER update_team_member '('$project6', '$user20')')
echo $(dfx --identity user7 canister call $CANISTER update_team_member '('$project7', '$user21')')
echo $(dfx --identity user8 canister call $CANISTER update_team_member '('$project8', '$user22')')
echo $(dfx --identity user9 canister call $CANISTER update_team_member '('$project9', '$user23')')
echo $(dfx --identity user9 canister call $CANISTER update_team_member '('$project9', '$user24')')
