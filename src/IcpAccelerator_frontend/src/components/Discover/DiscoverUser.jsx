  ...
  >
    {allUserData.length > 0 ? (
      allUserData.map(([principal, user], index) => {
        ...
        return (
          <div className="md:p-6 my-10 md:my-0 w-full md:w-[750px] rounded-lg shadow-sm mb-4 flex flex-col md:flex-row" key={index}>
            <div className=" w-full md:w-[272px] relative">
              <div
                onClick={() => handleClick(user)}
                className="w-full md:max-w-[250px] md:w-[250px] h-[254px] bg-gray-100 rounded-lg flex flex-col justify-between overflow-hidden"
              >
