          ...
          <div className="text-sm font-medium text-center text-gray-200 ">
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="relative z-0 group mb-6">
                  <label
                    htmlFor="investor_portfolio_link"
                    className="block mb-2 text-lg font-medium text-gray-500 hover:text-black hover:whitespace-normal truncate overflow-hidden text-start"
                  >
                ...
                <div className="relative z-0 group mb-6">
                  <label
                    htmlFor="invested_in_multi_chain"
                    className="block mb-2 text-lg font-medium text-gray-500 hover:text-black hover:whitespace-normal truncate overflow-hidden text-start"
                  >
                ...
                {watch("invested_in_multi_chain") === "true" ? (
                  <div className="relative z-0 group mb-6">
                    <label
                      htmlFor="invested_in_multi_chain_names"
                      className="block mb-2 text-lg font-medium text-gray-500 hover:text-black hover:whitespace-normal truncate overflow-hidden text-start"
                    >
                ...
                watch("investment_stage") === "we do not currently invest" ? (
                  <></>
                ) : (
                  <div className="relative z-0 group mb-6">
                    <label
                      htmlFor="investment_stage_range"
                      className="block mb-2 text-lg font-medium text-gray-500 hover:text-black hover:whitespace-normal truncate overflow-hidden text-start"
                    >
