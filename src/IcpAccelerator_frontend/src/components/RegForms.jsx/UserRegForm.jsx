    ...
    <>
      ...
      <section className="w-full h-fit px-[6%] lg1:px-[4%] bg-gray-100">
        <div className="w-full h-full bg-gray-100 pt-8 sm:text-left text-center">
          <div className="bg-gradient-to-r from-purple-800 to-blue-500 text-transparent bg-clip-text text-[30px]  sm:text-[25px] md1:text-[30px] md2:text-[35px] font-black font-fontUse dxl:text-[40px] p-6 mt-[35px]">
            User Information
          </div>
