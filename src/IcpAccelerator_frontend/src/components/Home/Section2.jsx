  ...
  return (
   <>
     ...
     <div className="max-w-7xl w-full py-8 px-4 sm:px-6 lg:px-8  mx-auto">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-2">
        <div className="py-6  bg-[#E0F2FE] rounded-3xl overflow-hidden">
          <div className="flex items-center mb-4">
            <img src={Founder} alt="Founders" className="w-[265px] h-[390px] mr-4" />
            <div className='px-3'>
        ...
        <div className="py-6 bg-[#FEF0C7] rounded-3xl overflow-hidden">
          <div className="flex items-center mb-4">
            <img src={Investor} alt="Investors" className="w-[265px] h-[390px] mr-4" />
            <div className='px-3'>
        ...
        <div className="py-6 bg-[#FDEAD7] rounded-3xl overflow-hidden">
          <div className="flex items-center mb-4">
            <img src={Investor} alt="Mentors" className="w-[265px] h-[390px] mr-4" />
            <div className='px-3'> 
        ...
        <div className="py-6 bg-[#CCFBEF] rounded-3xl overflow-hidden">
          <div className="flex items-center mb-4">
            <img src={Talents} alt="Talent" className="w-[265px] h-[390px] mr-4" />
            <div className='px-3'>
      ...
      <div className="relative -top-[541px] flex items-center justify-center w-full mt-8">
