            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 min ml-2">
                <ul className="space-y-8 relative">
                  {/* Vertical Line */}
                  <div className="absolute left-4 top-0 bottom-0 md:h-80 dlg:left-[14px] lg1:left-4 lg1:h-64 h-64 w-0.5 bg-gray-300"></div>
                  <li className="flex items-start">
                    <span className="bg-[#F7B27A] text-white rounded-full h-8 w-8 md:w-[2.7rem] dlg:w-8 flex items-center justify-center mr-4 relative z-10">
