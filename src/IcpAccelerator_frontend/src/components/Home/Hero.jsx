...
const HeroSection = () => {
  ...
  return (
    <section className={`bg-[${homepagedata.section1.backgroundColor}] relative overflow-hidden`}>
            ...
            <div className="w-full md:w-1/2 mb-8 md:mb-0 pt-16">
              <div className="max-w-[640px]">
                ...
                <h1 className="text-6xl md:text-7xl font-bold text-[#121926] leading-tight mb-4">
                  {homepagedata.section1.content.mainHeading.split(" ").map((word, index) =>
                ...
                >
                  {homepagedata.section1.content.buttonText} <homepagedata.section1.arrowForwardIcon.ArrowForwardIcon className="ml-2" />
                </button>
              </div>
            </div>
          </div>
