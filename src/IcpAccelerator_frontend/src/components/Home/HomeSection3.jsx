        ...
        <div className="container mx-auto">
          <div className="max-w-6xl w-full px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <p className="text-[#121926] text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mb-5 leading-8 sm:leading-10 md:leading-[50px] lg:leading-[60px] max-w-4xl">
                ...
                <span className="bg-red-400 font-bold text-white">
                  {homepagesection3.paragraph3.highlightedText3.text}
                </span>{" "}
                {homepagesection3.paragraph4.text}
                <span className="bg-green-400 font-bold text-white">
                  {homepagesection3.paragraph4.highlightedText4.text}
                </span>{" "}
                {homepagesection3.paragraph5.text}
              </p>
              <p className="text-[#121926] text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mb-5 leading-8 sm:leading-10 md:leading-[50px] lg:leading-[60px] max-w-4xl">                {homepagesection3.paragraph6.text}
              </p>
            </div>
          </div>
        </div>
