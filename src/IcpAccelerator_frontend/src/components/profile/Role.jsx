    ...
    return (
        <div className='flex flex-col'>
            <div className='flex justify-center items-center  w-full  mt-[2%] '>
                <div className='border-2 rounded-lg pb-5 text-center min-w-[250px] max-w-[350px] '>
            ...
            <div className="flex justify-between items-center mt-[8%] ">
                <div className='border-2 rounded-lg text-center min-w-[220px] max-w-[350px] '>
                    ...
                    <div className='my-5  px-5 flex items-center' >
                        <button className='border rounded-md bg-[#155EEF] p-2  font-medium w-full text-white'><span className='pr-2 text-white'><PersonAddAlt1OutlinedIcon sx={{ marginTop: "-6px", fontSize: "medium" }} /></span>Add a role </button>
                    </div>
                </div>
                <div className='border-2 rounded-lg text-center min-w-[220px] max-w-[350px] '>
                    <div className='p-3 flex justify-center mt-5 '>
