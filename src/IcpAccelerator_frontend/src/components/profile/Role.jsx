...
const FAQItem = ({ question, answer }) => {
  ...
  return (
    <div className='border-b border-gray-200'>
      <button
        className='flex justify-between items-center w-full text-left py-2 md:py-4'
...
const FAQ = () => {
  ...
  return (
    <div className=' mb-8 text-[#121926] text-[18px] font-medium border-gray-200  rounded-md p-1'>
  ...
  function mergeData(backendData, additionalData) {
    return backendData?.map((item, index) => {
      ...
      return additionalInfo
        ? { ...item, ...additionalInfo, key: item.id || index }
      ...
      <>
        ...
        >
          ...
          <path
            ...
            stroke={
              role?.approval_status === 'approved' ? 'currentColor' : '#E3E8EF'
            }
            strokeWidth='2'
    ...
    if (
      ...
      elements.push(
        <RoleProfileCard
          ...
          image={projectRole.image}
          message={projectRole.message}
        />
      );
      cardsShown++;
      elements.push(<ProfileRoleNoDataCard key='no-data-card' />);
      cardsShown++;
    }
    ...
    if (
      ...
      elements.push(
        <RoleProfileCard
          ...
          image={mentorRole.image}
          message={mentorRole.message}
        />
      );
      cardsShown++;
      elements.push(
        <div
          className='  md:w-3/4  p-6  h-60 flex flex-col items-center relative border-2 rounded-lg text-center w-full mb-6 md:mb-0 shadow-md '
          key='mentor-vc-default-card'
        >
