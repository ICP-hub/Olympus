...
// import useTruncatedSuccessToast from "../hooks/useTruncatedSuccessToast";
...
const NormalUser = () => {
  ...
  // const showSuccessToast = useTruncatedSuccessToast();
  ...
  const onSubmitHandler = async (data) => {
    const userData = {
      ...
      openchat_username: [data.openchat_username] || [],
      bio: [data.bio] || [],
      email: [data.email] || [],
      telegram_id: [data.telegram_id] || [],
      twitter_id: [data.twitter_id] || [],
      country: data.country,
      area_of_intrest: data.area_of_intrest,
    ...
    try {
      ...
      toast.success(result,{
        style: {
          maxWidth: '380px', // Set a maximum width for the toast
          whiteSpace: 'nowrap', // Prevents the text from wrapping to the next line
          overflow: 'hidden', // Hides overflow content
          textOverflow: 'ellipsis', // Adds an ellipsis to truncated content
          padding:'10px'
        },
      });
