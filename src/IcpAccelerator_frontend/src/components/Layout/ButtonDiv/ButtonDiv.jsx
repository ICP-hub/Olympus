  ...
  if (role?.status === 'active') {
    return (
      <div className='font-semibold text-xl w-2/6'>
        <button
          className='text-gray-100 py-1 px-2 rounded-md w-full bg-green-600 capitalize cursor-not-allowed'
          disabled={true}
        >
          current
        </button>
    ...
    return (
      <div className='font-semibold text-xl w-2/6'>
        <button
          className='text-white py-1 px-2 rounded-md w-full bg-blue-500 capitalize'
          onClick={() =>
            dispatch(
    ...
    return (
      <div className='font-semibold text-xl w-2/6'>
        <button
          className='text-white py-1 px-2 rounded-md w-full bg-red-500 capitalize cursor-not-allowed'
          disabled={true}
        >
          pending
        </button>
    ...
    return (
      <div className='font-semibold text-xl w-2/6'>
        <button
          className='text-black py-1 px-2 rounded-md w-full bg-blue-300 capitalize'
