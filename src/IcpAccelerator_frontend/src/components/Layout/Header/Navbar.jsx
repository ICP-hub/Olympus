                ...
                <div className='container mx-auto h-11 flex items-center justify-around '>
                    ...
                    <div className='flex gap-4'>
                       <Link to='/dashboard'><button className=' p-2 font-semibold'>Log in </button></Link> 
                        <button className='border rounded-md bg-[#155EEF] p-2 font-semibold text-white' onClick={manageHandler}>Get started <span className='pl-1 text-white'><EastIcon /></span></button>
                    </div>
                </div>
            </nav>
