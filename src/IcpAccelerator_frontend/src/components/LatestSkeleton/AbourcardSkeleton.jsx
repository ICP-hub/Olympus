            ...
            <div className="w-1/2 bg-gradient-to-r from-[#ECE9FE] to-[#FFFFFF] items-center justify-center rounded-r-2xl">
                ...
                <div className="bg-white mx-auto my-10  rounded-lg shadow-md w-3/4">
                    <div className='w-full bg-gray-200 rounded-full h-1.5 mb-4 dark:bg-gray-700'>
                        <div className="bg-green-500 h-1.5 rounded-full dark:bg-gray-700 " style={{ width: "20%" }}></div></div>
                    <div className='p-6'>
                        <div className="flex flex-col items-center">
                            ...
                            <h2 className="text-xl font-semibold"><Skeleton height={25} width={160} className="rounded-3xl" /></h2>
                            <span className=""><Skeleton height={20} width={130} className="rounded-3xl" /></span>
                        </div>
