...
const InvestorSideAssociation = () => {
  ...
  const fetchPendingRequestFromInvestorToProject = async () => {
    try {
      const result =
        await actor.get_all_offers_which_are_pending_for_investor();
      console.log(
        `result-in-get_all_offers_which_are_pending_for_investor`,
        result
      );
      setData(result);
    } catch (error) {
      console.log(
        `error-in-get_all_offers_which_are_pending_for_investor`,
        error
      );
      setData([]);
    }
  ...
  const fetchApprovedRequestFromInvestorToProject = async () => {
    try {
      const result =
        await actor.get_all_requests_which_got_accepted_for_investor();
      console.log(
        `result-in-get_all_requests_which_got_accepted_for_investor`,
        result
      );
      setData(result);
    } catch (error) {
      console.log(
        `error-in-get_all_requests_which_got_accepted_for_investor`,
        error
      );
      setData([]);
    }
  ...
  const fetchDeclinedRequestFromInvestorToProject = async () => {
    try {
      const result =
        await actor.get_all_requests_which_got_declined_for_investor();
      console.log(
        `result-in-get_all_requests_which_got_declined_for_investor`,
        result
      );
      setData(result);
    } catch (error) {
      console.log(
        `error-in-get_all_requests_which_got_declined_for_investor`,
        error
      );
      setData([]);
    }
  ...
  const fetchSelfRejectedRequestFromInvestorToProject = async () => {
    try {
      const result =
        await actor.get_all_requests_which_got_self_declined_for_investor();
      console.log(
        `result-in-get_all_requests_which_got_self_declined_for_investor`,
        result
      );
      setData(result);
    } catch (error) {
      console.log(
        `error-in-get_all_requests_which_got_self_declined_for_investor`,
        error
      );
      setData([]);
    }
