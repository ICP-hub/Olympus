...
const MentorSideAssociation = () => {
    ...
    const fetchPendingRequestFromProjectToMentor = async () => {
        ...
        try {
            const result = await actor.get_pending_request_for_mentor(mentor_id);
            console.log(`result-in-get_pending_request_for_mentor`, result);
            setData(result)
        } catch (error) {
            console.log(`error-in-get_pending_request_for_mentor`, error);
            setData([]);
        }
    }
    ...
    const fetchApprovedRequestFromProjectToMentor = async () => {
        let mentor_id = Principal.fromText(principal)
        try {
            const result = await actor.get_accepted_request_for_mentor(mentor_id);
            console.log(`result-in-get_accepted_request_for_mentor`, result);
            setData(result)
        } catch (error) {
            console.log(`error-in-get_accepted_request_for_mentor`, error);
            setData([]);
        }
    }
    ...
    const fetchDeclinedRequestFromProjectToMentor = async () => {
        let mentor_id = Principal.fromText(principal)
        try {
            const result = await actor.get_declined_request_for_mentor(mentor_id);
            console.log(`result-in-get_declined_request_for_mentor`, result);
            setData(result)
        } catch (error) {
            console.log(`error-in-get_declined_request_for_mentor`, error);
            setData([]);
        }
    }
    ...
    const fetchSelfRejectedRequestFromProjectToMentor = async () => {
        try {
            const result = await actor.get_self_declined_requests_for_mentor();
            console.log(`result-in-get_self_declined_requests_for_mentor`, result);
            setData(result)
        } catch (error) {
            console.log(`error-in-get_self_declined_requests_for_mentor`, error);
            setData([]);
        }
    }
    ...
    const fetchPendingRequestFromMentorToProject = async () => {
        ...
        try {
            ...
            console.log(`result-in-get_all_offers_which_are_pending_for_mentor`, result);
            setData(result)
        } catch (error) {
            console.log(`error-in-get_all_offers_which_are_pending_for_mentor`, error);
            setData([]);
        }
    }
    ...
    const fetchApprovedRequestFromMentorToProject = async () => {
        try {
            const result = await actor.get_all_requests_which_got_accepted_for_mentor();
            console.log(`result-in-get_all_requests_which_got_accepted_for_mentor`, result);
            setData(result)
        } catch (error) {
            console.log(`error-in-get_all_requests_which_got_accepted_for_mentor`, error);
            setData([]);
        }
    }
    ...
    const fetchDeclinedRequestFromMentorToProject = async () => {
        try {
            const result = await actor.get_all_requests_which_got_declined_for_mentor();
            console.log(`result-in-get_all_requests_which_got_declined_for_mentor`, result);
            setData(result)
        } catch (error) {
            console.log(`error-in-get_all_requests_which_got_declined_for_mentor`, error);
            setData([]);
        }
    }
    ...
    const fetchSelfRejectedRequestFromMentorToProject = async () => {
        try {
            const result = await actor.get_all_requests_which_got_self_declined_for_mentor();
            console.log(`result-in-get_all_requests_which_got_self_declined_for_mentor`, result);
            setData(result)
        } catch (error) {
            console.log(`error-in-get_all_requests_which_got_self_declined_for_mentor`, error);
            setData([]);
        }
    }
    ...
    const handleSelfReject = async (offer_id) => {
        try {
            const result = await actor.self_decline_request_for_mentor(offer_id);
...
export default MentorSideAssociation;