...
import { LiveProjectSkeleton } from "../../Dashboard/Skeleton/Liveprojectskeleton";

const delay = (ms) => new Promise((resolve) => setTimeout(resolve, ms));
const EventProjectViewMore = () => {
  ...
  const navigate = useNavigate();
   const { allProjectData } = location.state || {};
...
//     setIsLoading(true);
//     await delay(500);
//     await caller.get_projects_applied_for_cohort()
//       .then((result) => {
  ...
  return (
    <div className="container mx-auto">
      <div className="px-[4%] pb-[4%] pt-[2%]">
       ...
       font-fontUse"
          >
            All Associate Projects in Cohort
          </div>
...
export default EventProjectViewMore;
