    ...
    <footer className="bg-[rgb(254,246,238)] py-10 px-4 md:px-8 ">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          ...
          <button className="bg-[#155EEF] text-white text-lg py-3 px-6 rounded-[4px] w-full md:w-auto">
            {footer.buttonText}
          </button>
        </div>
        ...
        <div className="border-t border-[#bd10e0bf] pt-8">
          <div className="flex flex-wrap justify-between">
            ...
            text-left">
              <h3 className="text-xl font-semibold mb-4">
                <img src={footer.logo.logo} alt="logo" className="inline-block" />
              </h3>
          ...
          {/* Footer bottom section */}
                    <div className="border-t border-gray-200 mt-2 pt-8 flex flex-col md:flex-row justify-between items-center text-gray-600 text-sm">             {/* Policies and Social Links for Mobile (vertical alignment) */}
