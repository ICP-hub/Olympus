    ...
    <div className='w-full h-fit bg-indigo-300 rounded-md shadow'>
      <div className='relative'>
        ...
        <div className='p-8 flex flex-col justify-between items-center md:flex-row md:justify-start h-fit'>
          <div className='flex md:flex-col justify-center md:w-1/4 relative md:flex-1 mb-8'>
            <img src={BigLogo} alt='BigLogo' loading='lazy' draggable={false} />
          ...
          <div className='flex flex-col w-full md:w-3/4'>
            ...
            <div className='flex flex-col z-10 ss4:flex-row items-center gap-2 md:items-center md:ml-14'>
              <input
                type='email'
              ...
              <button
                type='submit'
                className='bg-white text-violet-900 font-bold px-4 py-2  rounded-md text-lg md:ml-2'
              >
                SUBMIT
              </button>
            </div>
