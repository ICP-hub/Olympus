  ...
  return (
    <div className='min-h-screen bg-white'>
      <main className=' mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        <h1 className='text-6xl font-bold text-gray-900 mb-12'>Terms of Use</h1>
        <p className='text-gray-700 mb-6'>
          ...
          agree to abide by these Terms. If you disagree with any part of these
        ...
        <div className='space-y-8'>
          ...
          <section>
            ...
            <p classname='text-xl'>
              ...
              [Your Organization] (“we,” “us,” or “our”). By accessing,
          ...
          <section>
            ...
            <p classname='text-xl'>
              To use our website and services, you must be at least 18 years old
              or the legal age of majority in your jurisdiction. By using our
          ...
          <section>
            ...
            <p classname='text-xl'>
              ...
              access and use our website and services for personal,
          ...
          <section>
            ...
            <ul className='list-disc ml-6'>
              ...
              <li>Introducing harmful software such as viruses or malware.</li>
          ...
          <section>
            ...
            <p classname='text-xl'>
              ...
              direct, indirect, or consequential damages arising from your use
          ...
          <section>
            ...
            <p classname='text-xl'>
              ...
              without any warranties. We do not guarantee that the website will
          ...
          <section>
            ...
            <p classname='text-xl'>
              We may terminate or suspend your access to our website or services
              at any time for any reason, including violations of these Terms.
            </p>
          </section>
          ...
          <section>
            ...
            <p classname='text-xl'>
              ...
              our control, including natural disasters, acts of war, or internet
              outages.
            </p>
          </section>
          ...
          <section>
            ...
            <p classname='text-xl'>
              ...
              We may assign these Terms without notice or consent.
            </p>
          </section>
