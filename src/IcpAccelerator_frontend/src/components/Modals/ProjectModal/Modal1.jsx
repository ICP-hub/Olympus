  ...
  const roles = [
    {
      name: 'user',
      image: founder,
      description: 'List your project, build connections, find investments',
    },
    {
      name: 'project',
      image: project,
    ...
    },
    {
      name: 'vc',
      image: investor,
      description: 'Find promising projects, build your portfolio',
    },
    {
      name: 'mentor',
      image: mentor,
      description: 'Provide consultations, build professional network',
    },
  ];
