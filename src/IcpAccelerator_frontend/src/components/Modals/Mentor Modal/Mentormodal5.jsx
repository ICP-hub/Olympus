...
//                         />
//                         <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-normal text-black">$</span>
//                     </div>

//                 </div>
//                 <div className='mb-4'>
//                     <fieldset>
//                         <legend class="text-sm font-semibold mb-4 text-[#364152]">Do you accept tokens ?</legend>
...
//                                 name="response"
//                                 value="true"
//                                 class="h-4 w-4 text-blue-600 border border-black rounded-full cursor-pointer"
//                             />
//                             <label for="true" class="text-[#121926] text-sm font-semibold">Yes</label>
//                         </div>
//                         <div class="flex items-center mb-4">
//                             <input
//                                 id="false"
...
//                                 class="h-4 w-4 text-blue-600 border border-black rounded-full cursor-pointer" 
//                             />
//                             <label for="false" class="text-[#121926] text-sm font-semibold">No</label>
//                         </div>
//                         <button
//                             type="submit"
...
//                 <div className='mb-4'>
//                     <fieldset>
//                         <legend className="text-sm font-semibold mb-4 text-[#364152]">Do you accept tokens?</legend>
...
//                             />
//                             <label htmlFor="true" className="text-[#121926] text-sm font-semibold ml-2">Yes</label>
//                         </div>
//                         <div className="flex items-center mb-4">
//                             <input
//                                 id="false"
...
//                                 onChange={handleRadioChange}
//                             />
//                             <label htmlFor="false" className="text-[#121926] text-sm font-semibold ml-2">No</label>
//                         </div>
//                         <button
//                             type="submit"
