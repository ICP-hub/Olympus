                ...
                <div className="bg-white rounded-lg shadow-lg w-[500px] p-6 pt-4 overflow-y-auto">
                    <div className="flex justify-between mr-4">
                        <div>
                            ...
                            <h2 className="text-xs text-[#364152] mt-3">Step 1 of 1</h2></div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} >
                        <div >
                            ...
                            <div className="">
                                ...
                                >
                                    Job Title<span className="text-red-500
                    ">*</span>
                                </label>
                                ...
                                <input
                                    type="text"
                                    {...register("jobTitle")}
                                    className={`border border-[#CDD5DF] rounded-md shadow-sm ${errors.jobTitle ? "border-red-500 " : "border-[#737373]"
                            ...
                            <div className="">
                                <label
                                    ...
                                    className="block text-sm font-medium mb-1 mt-2"
                                >
                                    Job Location<span className="text-red-500
                    ">*</span>
                                </label>
                                <input
                                    type="text"
                                    {...register("jobLocation")}
                                    className={`border border-[#CDD5DF] rounded-md shadow-sm ${errors.jobLocation ? "border-red-500 " : "border-[#737373]"
                                        } text-gray-900 placeholder-gray-500  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5`}
                            ...
                            <div className="">
                                <label
                                    ...
                                    className="block text-sm font-medium mb-1 mt-2"
                                >
                                    Job Link<span className="text-red-500
                    ">*</span>
                                </label>
                                <input
                                    type="text"
                                    {...register("jobLink")}
                                    className={`border border-[#CDD5DF] rounded-md shadow-sm ${errors.jobLink ? "border-red-500 " : "border-[#737373]"
                                        } text-gray-900 placeholder-gray-500  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5`}
                            ...
                            <div className="">
                                <label
                                    ...
                                    className="block text-sm font-medium mb-1 mt-2"
                                >
                                    Jobs Category<span className="text-red-500
                    ">*</span>
                                </label>
                                <select
                                    {...register("jobCategory")}
                                    className={`border border-[#CDD5DF] rounded-md shadow-sm ${errors.jobsCategory ? "border-red-500 " : "border-[#737373]"
                                        } text-gray-900 placeholder-gray-500  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5`}
                                >
                                    <option className="text-lg font-bold" value="">
                                        Select any one Category<span className="text-red-500
                    ">*</span>
                                    </option>
                    ...
                    ">*</span>
                                ...
                                <textarea
                                    ...
                                    rows="4"
                                    className={`border border-[#CDD5DF] rounded-md shadow-sm ${errors.jobDescription ? "border-red-500 " : "border-[#737373]"
