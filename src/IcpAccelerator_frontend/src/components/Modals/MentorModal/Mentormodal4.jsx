...
const Mentormodal4 = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className='bg-white rounded-lg p-6 w-[500px] max-h-[100vh] overflow-y-auto overflow-hidden'
      ...
      >
        ...
        <div className='mb-4'>
          ...
          {deliverables.map((deliverable, index) => (
            <div
              key={index}
              className='mb-2 p-4 border rounded-lg bg-[#F8FAFC]'
            >
              <input
                type='text'
                name='title'
        ...
        <div className='mb-4'>
          ...
          <button onClick={handleAddfaq} className='text-blue-500 text-sm'>
            Add another FAQ
          </button>
        </div>
