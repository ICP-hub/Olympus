    ...
    >
      <div className='bg-white rounded-lg shadow-lg w-[550px] p-6'>
        ...
        <p className='text-[#697586] mb-4'>
          Tell others a bit about your founding expertise. You can update it
          later.
        </p>
        <form>
          <div className='mb-2 relative'>
            <label className='block text-sm text-[#364152] font-medium mb-1'>
              Primary expertise <span className='text-[red] ml-1'>*</span>
            </label>
            <Select
          ...
          <div className='mb-2'>
            <button className='text-[#004EEB] text-sm' type='button'>
