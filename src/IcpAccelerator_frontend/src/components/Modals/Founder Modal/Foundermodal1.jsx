...
import Foundermodal2 from './Foundermodal2'
const selectStyles = {
    control: (provided) => ({
        ...provided,
...
const ExpertiseModal = ({ isOpen, onClose }) => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white rounded-lg shadow-lg w-[550px] p-6">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-sm font-semibold text-[#364152]">Step 1 of 3</h2>
                    <button onClick={onClose} className="text-[#364152] text-2xl">&times;</button>
                </div>
            ...
            {showFoundermodal2 && <Foundermodal2 isOpen={showFoundermodal2} onClose={() => setShowFoundermodal2(false)} />}
