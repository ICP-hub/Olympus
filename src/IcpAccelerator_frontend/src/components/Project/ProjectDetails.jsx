        ...
        <div className="flex-col">
          ...
          <div>
            <div className="text-sm font-extrabold text-center text-[#737373] ">
              <ul className="flex flex-wrap -mb-px text-sxxs:text-[7px] sxs:text-[7.5px] sxs1:text-[8px] sxs2:text-[8.5px] sxs3:text-[9px] ss:text-[9.5px] ss1:text-[10px] ss2:text-[10.5px] ss3:text-[11px]  cursor-pointer">
            ...
            {/* {activeTab === "teamMember" && <ProjectDescription />} */}
            {/* {activeTab === "resources" && <ProjectDescription />} */}
          </div>
        </div>
      </div>
