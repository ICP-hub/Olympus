...
console.log("currentStep ===>", currentStep)
  ...
  //   const foundIndex = sendingArray.findIndex(
  //     (item) => item.level_name === name
  //   );
  //   if (foundObject && foundIndex !== -1) {
  //     sendingArray[foundIndex].sub_level =
  //       rubric_table_data[currentStep].levels[step].title;
              ...
              <div className="transition-all duration-200 max-h-screen">
                <div className="p-4">
                  ...
                  <div className="text-white text-lg font-bold font-fontUse mb-2">
                    Rate {rubric_table_data[currentStep].title.toUpperCase()} on
                    scale of 9
                  </div>
                  <div className="relative my-8">
                    ...
                    <ReactSlider
                      ...
                      renderMark={({ key, style }) => {
                        let level_title =
                          rubric_table_data[currentStep].levels[key].title;
                        let level_desc =
                          rubric_table_data[currentStep].levels[key].desc;
                        return (
                          <div
                            key={key}
              ...
              <div className="mix-blend-darken bg-[#B9C0F3] text-gray-800 my-4 rounded shadow-md w-full mx-auto p-8">
                <div className="flex items-center justify-between cursor-pointer">
                  ...
                  <div className="mx-4 flex items-center w-full">
                    <Line
                      ...
                      percent={Number(
                        Math.round(
                          ((sliderValues[sliderKeys[currentStep]] + 1) * 100) /
                            9
                        )
                      )}
                      strokeColor="white"
                    ...
                    <div className="text-white text-[15px] font-normal font-fontUse ml-2">
                      {Math.round(
                        ((sliderValues[sliderKeys[currentStep]] + 1) * 100) / 9
                      )}
                      %
                    </div>
                    {star}
                ...
                <div>
                  <p className="pr-24">
                    ...
                    South Korea and the U.S. Both founders are Forbes Asia 30
                    under 30 honorees. PANY was establishedPANONY was
                    established in March 2018 with operations in Greater China,
                    South Korea and the U.S. Both founders are Forbes Asia 30
                    under 30 honorees. PANY was established
                  </p>
                  <ConsentForm
                    ...
                    onSubmitHandler={(name, step) =>
                      appendSendDataFunc(name, step)
                    }
