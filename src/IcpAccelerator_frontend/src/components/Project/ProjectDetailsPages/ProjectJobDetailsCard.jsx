        ...
        <div className="py-4 gap-2 overflow-x-auto">
            ...
            >
                {latestJobs.map((card, index) => {
                    ...
                    let job_project_logo = card?.project_logo ? uint8ArrayToBase64(card?.project_logo) : '';
                    let job_project_name = card?.project_name ?? '';
                    let job_project_desc = card?.project_desc ?? '';
                    let job_post_time = card?.timestamp ? formatFullDateFromBigInt(card?.timestamp) : '';
                    return (
                                            ...
                                            <div className="sm:w-1/2">
                                                <div className="pt-2 flex">
                                                    ...
                                                    <div className="mt-auto pl-2">
                                                        <p className="text-base font-[950]">{job_project_name}</p>
