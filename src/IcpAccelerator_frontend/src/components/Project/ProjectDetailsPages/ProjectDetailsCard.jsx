...
function ProjectDetailsCard({ data, image, title, rubric, tags, socials, doj, country, website, dapp }) {
    ...
    return (
        <>
            <div className="p-6 xxs1:block hidden shadow-2xl bg-[#FFFFFF4D] border-[#E9E9E9] border-1 drop-shadow-[#0000000D] rounded-[10px]">
            ...
            <div className="p-6 xxs1:hidden block shadow-2xl bg-[#FFFFFF4D] border-[#E9E9E9] border-1 drop-shadow-[#0000000D] rounded-[10px]">
                <div className="flex items-center">
                    <div className="flex">
                        {image &&
                            (<img
