...
const Filterdata = () => {
    ...
    OutSideClickHandler(countryPopupRef, () => setIsCountryPopupOpen(null));
    const customStyles = `
    .slider-mark::after {
...
{/* Levelpopup Start */}
{isLevel && (
        <div className="absolute w-full top-12  bg-white shadow-md rounded-lg border border-gray-200 p-3 z-10" ref={countryPopupRef}>
     <div className='flex flex-wrap flex-row gap-2 space-x-2'>
...
{/* Genrepopup Start  */}
{isGenre && (
<div className="absolute w-full top-24  bg-white shadow-md rounded-lg border border-gray-200 p-3 z-10" ref={countryPopupRef}>
<div className='flex flex-wrap flex-row gap-2 space-x-2'>
...
{/* {isrange && (
  ...
  <div className="w-full  flex justify-center">
      ...
      <div className="  shadow-md rounded-lg overflow-hidden  drop-shadow-xl gap-2 bg-gray-200  p-4 ">
