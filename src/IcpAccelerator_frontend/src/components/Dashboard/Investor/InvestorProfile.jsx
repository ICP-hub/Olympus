...
const InvestorProfile = () => {
  ...
  let projectOnMultichain =
    investorProfileData?.project_on_multichain &&
    investorProfileData?.project_on_multichain.length > 0 &&
    investorProfileData?.project_on_multichain[0] &&
    investorProfileData?.project_on_multichain[0].trim() !== ""
      ? investorProfileData?.project_on_multichain[0].trim()
      : null;
  let fundSize = investorProfileData?.fund_size;
  let averageCheckSize = investorProfileData?.average_check_size;
  let moneyInvested =
    investorProfileData?.money_invested &&
    investorProfileData?.money_invested.length > 0 &&
    typeof investorProfileData?.money_invested[0] === "number"
      ? investorProfileData?.money_invested[0]
      : null;
  ...
  let portfolio_link = investorProfileData?.portfolio_link;
  let investor_type = investorProfileData?.investor_type?.[0];
  let RegisteredCountry = investorProfileData?.registered_country?.[0];
    ...
    <div className="px-[4%] w-full bg-gray-100 overflow-y-scroll font-fontUse">
      <div className="border-[#DCDCDC] border-b p-5 pb-4 rounded-2xl">
        ...
        <div className="md:flex block w-full md:w-[60%]">
          <div className="w-full md:w-1/2">
            ...
            <div>
              <p className="text-[#737373] pt-2">{fundSize}</p>
            </div> */}
          ...
          <div className="col">
            ...
            <div className="flex items-center my-2">
              ...
              <h6 className="undeline ml-2">
                ...
                <span className="ml-2">{nameOfFund}</span>
              </h6>
            </div>
            <div className="flex items-center my-2">
              <svg
              ...
              <h6 className="undeline ml-2">
                <span className="font-bold">Fund size:</span>
                <span className="ml-2">{fundSize}</span>
              </h6>
            </div>
            <div className="flex items-center my-2">
              <svg
              ...
              <h6 className="undeline ml-2">
                ...
                <span className="ml-2">{investor_type}</span>
              </h6>
            </div>
            <div className="flex items-center my-2">
              ...
              <h6 className="undeline ml-2">
                ...
                <span className="ml-2">{openchat_username}</span>
              </h6>
            </div>
            {announcementDetails &&
              announcementDetails[0] &&
              announcementDetails[0] !== "" && (
                <div className="flex items-center my-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex items-center my-2">
              ...
              <h6 className="ml-2">
                {" "}
                <span className="font-bold">Registered country:</span>
                <span className="ml-2">{RegisteredCountry}</span>
              </h6>
            </div>
            <div className="flex items-center my-2">
              <svg
              ...
              <h6 className="ml-2">
                {" "}
                <span className="font-bold">Range of check size:</span>
                <span className="ml-2">{range_of_check_size}</span>
              </h6>
            </div>
          </div>
          {/* <div className="col">
            {existingIcpProjectPorfolio &&
              existingIcpProjectPorfolio[0] &&
              existingIcpProjectPorfolio[0].trim() !== "" && (
                <div className="flex items-center my-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
      ...
      <div>
            ...
            <div className="text-[15px] leading-4 flex items-center flex-wrap pt-2 gap-2">
              {typeOfInvestment.split(",").map((item, index) => {
                ...
                return (
                  <span
                    key={index}
                    className="bg-[#E7E7E8] flex font-bold items-center leading-none mt-2 px-3 py-2 rounded-full text-gray-600 text-sm"
                  >
                    {item.trim()}
                  </span>
                );
        ...
        {stage && stage[0] && stage[0].trim() !== "" && (
          <div className="border-b border-[#DCDCDC] my-5 pb-12 p-5">
            <h4 className="text-xl font-[950]">
              Stages of Investment preferred
            </h4>
            <div className="text-[15px] leading-4 flex items-center flex-wrap pt-2 gap-2">
              {stage[0].split(",").map((item, index) => {
                ...
                return (
                  <span
                    key={index}
                    className="bg-[#E7E7E8] flex font-bold items-center leading-none mt-2 px-3 py-2 rounded-full text-gray-600 text-sm capitalize"
                  >
                    {item.trim()}
                  </span>
                );
        ...
        {projectOnMultichain &&
          ...
          projectOnMultichain[0].trim() !== "" && (
            <div className="border-b border-[#DCDCDC] my-5 pb-12 p-5">
              <h4 className="text-xl font-[950]">
                Ecosystems {investorName?.split(" ")[0]} has worked with
              </h4>
              <div className="text-[15px] leading-4 flex items-center flex-wrap pt-2 gap-2">
                {projectOnMultichain.split(",").map((item, index) => {
                  console.log("item", item);
                  return (
                    <span
                      key={index}
        ...
        {id ===
          "hqgvf-ullh5-p3g44-mdyfg-tjtex-fsly6-weeud-d7qku-wafhg-rw6xp-7ae" && (
          <div className="border-b border-[#DCDCDC] my-5 pb-12 p-5">
            <h4 className="text-xl font-[950]">
              What projects say about {investorName?.split(" ")[0]}
            </h4>
                      ...
                      <div className="flex-1 px-1 py-2 sm:px-2 sm:py-4 leading-relaxed text-[#737373] text-base">
                        ...
                        <div className="text-sm sm:text-base text-black">
                          ...
                          <p className="line-clamp-2 sm:line-clamp-none">
                            We are deeply grateful for your investment and the
                            faith you've placed in our project. Your support has
                            been a cornerstone of our journey, enabling us to
                            transform our vision into a tangible reality. Thank
                            you for being more than an investor; thank you for
                            being a partner in our quest for innovation and
                            impact. Your contribution has been pivotal to our
