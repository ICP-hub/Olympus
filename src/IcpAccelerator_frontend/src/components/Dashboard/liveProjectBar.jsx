...
const LiveProjectBar = ({ data }) => {
  ...
  let linkedin_link =
    ...
    data?.params?.project_linkedin?.[0].trim() !== ""
      ...
      : null;
  let twitter_link =
    data?.params?.project_twitter?.[0] &&
    data?.params?.project_twitter?.[0].trim() !== ""
      ? data?.params?.project_twitter?.[0]
      : null;
  let website_link =
              ...
              {area_tags && area_tags.trim() !== ""
                ? area_tags
                    ...
                    .map((val, index) => (
                      <span
                        key={index}
                        className="bg-gray-300 px-2 py-1 rounded-2xl text-xs text-gray-500"
                      >
                        {val}
                      </span>
                    ))
                  ...
                  <img
                    ...
                    src={
                      data?.profile_picture[0]
                        ? uint8ArrayToBase64(data?.profile_picture[0])
                        : girl
                    }
                    alt={`Team`}
                  />
