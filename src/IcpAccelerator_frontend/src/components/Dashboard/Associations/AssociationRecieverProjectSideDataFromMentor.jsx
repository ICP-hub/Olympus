...
const AssociationRecieverProjectSideDataFromMentor = ({
  user,
  activeTabData,
  selectedTypeData,
    ...
    <>
      <div className='md:py-6 w-full flex flex-wrap md:flex-nowrap rounded-lg shadow-sm'>
        ...
        <div className='flex-grow mt-4 md:mt-0 ml-0 md:ml-[25px]  w-full '>
          ...
          <p className='text-gray-600 my-1 break-all line-clamp-2  min-h-16'>
...
export default AssociationRecieverProjectSideDataFromMentor;
