...
const AssociationProjectInfo = ({ key, user }) => {
  // Offer details
    ...
    <div className='p-4' key={key}>
      ...
      <div className='group relative hover:bg-gray-100 rounded-lg p-1 mt-4'>
        ...
        <p className='text-[14px] line-clamp-3 break-all'>
          {projectDescription ? parse(projectDescription) : ''}
        </p>
      </div>
      ...
      <div className='group relative hover:bg-gray-100 rounded-lg p-1 mt-2'>
        ...
        <span className='text-[14px]'>{countryofregistration}</span>
      </div>
...
export default AssociationProjectInfo;
