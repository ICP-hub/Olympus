      ...
      <div className='flex flex-col md:flex-row '>
        ...
        {isFiltersOpen && (
          ...
          >
            ...
            <motion.div className='fixed bottom-0 left-0 lg:left-auto lg:w-[75%] dlg:w-[77%] lgx:w-full lgx:left-0 right-0 bg-white z-40 p-6 rounded-t-3xl shadow-lg min-h-40'>
