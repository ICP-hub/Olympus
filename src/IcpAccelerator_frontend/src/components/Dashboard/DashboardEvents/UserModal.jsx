...
import UserModalSkeleton from './DashboardEventSkeletons/UserModalSkeleton';
...
const UserModal = ({ openDetail, setOpenDetail, userData }) => {
  ...
  return (
    ...
    >
      {openDetail && userData && (
        <div
          className={`mx-auto w-full sm:w-auto lg:w-[30%] absolute right-0 top-0 bg-white h-screen transform transition-transform duration-500 ease-[cubic-bezier(0.4, 0, 0.2, 1)] ${
              ...
              <div className='flex justify-center p-4'>
                <div className='container bg-white rounded-lg shadow-sm p-4 overflow-hidden w-full max-w-[400px]'>
                  ...
                  <div className='p-0 bg-white'>
                    ...
                    <div className='px-1'>
                      <div className='mb-4'>
                        <h3 className='font-semibold mb-2 text-xs text-gray-500 uppercase mt-2'>
                          About
                        </h3>
                        <p className='text-sm'>
                      ...
                      <div className='mb-4'>
                        ...
                        <div className='flex flex-wrap gap-2'>
                          {userData?.reason?.map((reasontojoin, index) => (
                            <span
                              key={index}
                              className='border-2 border-gray-500 rounded-full text-gray-700 text-xs px-2 py-1'
                            >
