...
const UserModal = ({ openDetail, setOpenDetail, userData }) => {
  return (
    ...
    >
      {openDetail && userData && (
        <div
          className={`mx-auto w-full sm0:w-auto lg1:w-[30%] absolute right-0 top-0 bg-white h-screen transform transition-transform duration-[4000ms] ease-[cubic-bezier(0.4, 0, 0.2, 1)] ${openDetail ? 'translate-x-0' : 'translate-x-full'} z-20`}
        >
          <div className='p-5 '>
            <CloseIcon
              sx={{ cursor: 'pointer' }}
