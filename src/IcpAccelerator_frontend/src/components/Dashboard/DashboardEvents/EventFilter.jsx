...
const Filters = ({ setSelectedEventType }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm block md:block sticky top-0">
        ...
        <div>
          ...
          <div className="relative">
            <Select
              ...
              className="w-full"
              placeholder="Select event type"
              menuPortalTarget={document.body} // Ensures the menu is rendered inside the body
              menuPlacement="auto" // Automatically adjusts menu placement
              styles={{
                menuPortal: (base) => ({
                  ...base,
