    ...
    <div className='p-0 md:p-6'>
      ...
      <div className='text-center py-4 md:py-12'>
        ...
        <h2 className='text-xl font-semibold mb-2'>
          You haven't posted any cohort yet
        </h2>
        ...
        <button
          className='bg-[#155EEF] text-white px-4 py-2 rounded-md flex items-center justify-center mx-auto w-full truncate break-all md:w-auto'
