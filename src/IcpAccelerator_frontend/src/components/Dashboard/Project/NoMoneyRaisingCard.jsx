...
//   const [moneyRaisingData, setMoneyRaisingData] = useState([]); // Store money-raising data

//   const handleAddMoneyRaising = (newMoneyData) => {
//     setMoneyRaisingData([...moneyRaisingData, newMoneyData]); // Add new money-raising data to the array
//     setIsOpen(false); // Close the modal after submission
//   };

// console.log("data aa rha h kya dekho is page pe money raising pe sara",cardData)
...
//       ) : (
//         <div className="py-12">
//           <h2 className="text-xl font-semibold mb-4">Money Raised</h2>
//           <div>
//             {moneyRaisingData.map((data, index) => (
//               <MoneyRaisedCard key={index} cardData={cardData} /> // Render each MoneyRaisedCard
//             ))}
//           </div>
//           <button
//             className="bg-[#155EEF] text-white px-4 py-2 rounded-md flex items-center justify-center mx-auto mt-4"
//             onClick={() => setIsOpen(true)} // Open the modal for adding more money raising
//           >
...
//           // ProjectId={ProjectId}
//           onSubmit={handleAddMoneyRaising} // Pass the submit handler to the modal
//         />
//       )}
//     </div>
//   );
