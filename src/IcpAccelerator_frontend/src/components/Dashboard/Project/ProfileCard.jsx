...
import ProfileCardSkeleton from './ProjectSkeleton/ProfileCardSkeleton';
function ProfileCard({ cardData }) {
  ...
  return (
    <div className='container bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden w-full dlg:max-w-[440px]'>
