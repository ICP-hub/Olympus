  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <div className="w-full md:w-1/3 sticky top-16 self-start max-h-[calc(100vh-4rem)] overflow-y-auto">
          <div className="bg-gray-100 p-6">
            ...
            <h1 className="text-2xl font-bold mb-4">Landing page design</h1>

            <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700">
              Get it touch{" "}
              <ArrowOutwardIcon className="ml-1 transform" fontSize="small" />
            </button>
          </div>

          <div className="p-6">
            <div className="mb-6">
              <h3 className="text-sm font-normal text-gray-500 mb-2">ABOUT</h3>
              <p className="text-sm text-gray-600">
                A tortor laoreet ac magna nibh. Bibendum augue neque malesuada
                aliquam venenatis. Orci sed tortor vitae dolor. Cum blandit non
                odio vestibulum pretium id scelerisque. Lorem montes ornare
                vulputate egestas.
              </p>
            </div>
        ...
        <div className="w-full md:w-2/3">
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div className="flex items-center">
              <AttachMoneyIcon className="text-gray-500 mr-1" />
              <span>$1,000</span>
            </div>
          </div>
