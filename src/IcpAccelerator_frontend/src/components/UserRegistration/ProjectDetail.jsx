...
const ProjectDetail = () => {
    ...
    const defaultValues = {
        ...
        preferred_icp_hub:projectFullData?.preferred_icp_hub ?? "ICP Hub, Italia",
        project_name:projectFullData?.project_name ?? "Name of the project",
        project_description:projectFullData?.project_description ?? "This is the description of the project",
        project_elevator_pitch:projectFullData?.project_elevator_pitch ?? "https://pitch.com",
        project_website:projectFullData?.project_website ?? "https://projectwebsite.com",
        is_your_project_registered:projectFullData?.is_your_project_registered ?? "false",
        type_of_registration:projectFullData?.type_of_registration ?? "Company",
        country_of_registration:projectFullData?.country_of_registration ?? "India",
        live_on_icp_mainnet:projectFullData?.live_on_icp_mainnet ?? "false",
        dapp_link:projectFullData?.dapp_link ?? "https://dapplink.com",
        weekly_active_users:projectFullData?.weekly_active_users ?? 0,
        revenue:projectFullData?.revenue ?? 0,
        money_raising:projectFullData?.money_raising ?? "No",
        money_raised_till_now:projectFullData?.money_raised_till_now ?? "No",
        icp_grants:projectFullData?.icp_grants ?? 0,
        investors:projectFullData?.investors ?? 0,
        raised_from_other_ecosystem:projectFullData?.raised_from_other_ecosystem ?? 0,
        target_amount:projectFullData?.target_amount ?? 0,
        valuation:projectFullData?.valuation ?? 0,
        multi_chain:projectFullData?.multi_chain ?? "No",
        multi_chain_names:projectFullData?.multi_chain_names ?? "Polygon",
        promotional_video:projectFullData?.promotional_video ?? "https://promotionalvideo.com",
        project_discord:projectFullData?.project_discord ?? "https://discord.com",
        project_linkedin:projectFullData?.project_linkedin ?? "https://linkedin.com",
        github_link:projectFullData?.github_link ?? "https://githublink.com",
        token_economics:projectFullData?.token_economics ?? "",
        white_paper:projectFullData?.white_paper ?? "",
        upload_public_documents:projectFullData?.upload_public_documents ?? "false",
        publicDocs:projectFullData?.publicDocs ?? [],
        upload_private_documents:projectFullData?.upload_private_documents ?? "false",
        privateDocs:projectFullData?.privateDocs ?? [],
        link:projectFullData?.link ?? "",
    };
