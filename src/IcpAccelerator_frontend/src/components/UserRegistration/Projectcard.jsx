        ...
        <div className="flex flex-col items-center bg-white rounded-lg shadow-lg  mx-auto">
            ...
            <div className='flex mt-4 max-w-4xl'>
                ...
                <div className='mx-12'>
                    ...
                    <p className="mb-4 mt-2 text-normal ">Bringing privacy back to users</p>
                    ...
                    <span className=" my-2 text-base text-gray-700 px-2 py-1 rounded-full border-2 border-gray-300">Infrastructure</span>
                </div>
            ...
            <div className="mt-8 flex flex-col items-center">
                ...
                <button className="mt-4 bg-[#155EEF] text-white px-4 py-2 rounded-lg text-lg">+ Add project</button>
            </div>
        </div>
    );
};
