      ...
      <div className="w-full px-[4%] lg1:px-[5%]">
        <div className="flex dxl:justify-end">
          <div className="w-full h-[400px] relative">
            ...
            <button className="rounded-sm border border-white absolute w-[210px] left-[19px] top-[210px] xl2:top-[209.5px] xl:top-[225px] dxl:top-[225px] lgx:top-[220px] lg1:top-[215px] dlg:top-[215px] lg:top-[210px] md3:top-[210px] md2:top-[205px] md1:top-[205px] md:top-[204.5px] sm:top-[204px] sm3:top-[195px] sm2:top-[190px] sm4:top-[185px] sm1:top-[185px] xxs1:top-[191px] xxs:top-[191px] dxs:top-[191px] ss4:top-[195px] ss3:top-[150px] ss2:top-[145px] ss1:top-[205px] ss:top-[155px] sxs3:top-[140px] sxs2:top-[140px] sxs1:top-[190px] sxs:top-[135px] sxxs:top-[135px]">
          ...
          <img src={HalfAstro} alt="HalfAstro" className={` hidden dxl:block transition-transform duration-1000 ease-in-out transform ${translate}`}/>
          <img src={FullAstro} alt="FullAstro" className={` dxl:hidden transition-transform duration-1000 ease-in-out transform z-20 w-[500px] relative  object-contain  md:top-[200px] top-[110px] ${translate} `}/>
        </div>
      </div>
    </section>
  );
