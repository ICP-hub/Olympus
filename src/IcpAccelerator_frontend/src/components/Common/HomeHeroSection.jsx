        ...
        <div className="flex dxl:justify-end">
          ...
          <div className="relative flex justify-center items-center bg-gray-100">
            <img
              src={FullAstro}
              alt="Astronaut"
              className={`z-20 w-[500px] relative top-4 right-16 transition-transform duration-1000 ease-in-out transform ${translate}`}
            />
            <div className="absolute top-[20px] -left-[10%] w-[320px] h-[320px] rounded-full bg-gradient-to-r from-purple-300/40 to-purple-600"></div>
            <div className="absolute top-[200px] left-[65%] w-[164px] h-[164px] rounded-full bg-gradient-to-r from-purple-900 to-blue-500 opacity-30"></div>
            <div className="absolute top-[120px] left-[45%] w-[190px] h-[200px] bg-gradient-to-b from-white/30 to-transparent rounded-lg backdrop-blur-sm"></div>
          </div>
        </div>
      </div>
    </section>
