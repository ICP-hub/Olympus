...
const DetailHeroSection = ({HeroImage}) => {
          ...
          <div className="w-full h-[600px] dxl:h-[500px] relative">
            ...
            <div className="right-[149px] md:right-[110px] md:top-[-35px] top-[32px] absolute">
              <img
                src={HalfAstro}
                alt="HalfAstro"
                className={` bottom-[8px] md:bottom-0  h-[260px] hidden md:block transition-transform duration-1000 ease-in-out transform ${translate}`}
              />
              <img
                src={astro1}
                alt="astro"
                className={` md:hidden right-[-165px] md:right-0 transition-transform duration-1000 ease-in-out transform z-20 w-[500px] relative  object-contain  md:top-[200px] top-[110px] ${translate} `}
              />
            </div>
          </div>
        </div>
