                ...
                <div className="bg-white shadow-xl rounded-2xl flex w-full max-w-6xl">
                    <div className="w-1/2 p-8">
                        <div className="mb-6">
                            ...
                            <h2 className=" font-semibold mb-2 mt-16 mx-12">Step 1 of 3</h2>
                            <h1 className="text-3xl font-bold mx-12">What is your name?</h1>
                        </div>
                        <form className="space-y-4 mx-12">
                            <div className='flex justify-between'>
                                <div >
                                    <label className="block">First name <span className='text-[#155EEF]'>*</span></label>
                                    <input type="text" className="mt-1 p-2 border border-gray-300 rounded w-full" placeholder="First name" />
                                </div>
                                <div >
                                    <label className="block">Last name <span className='text-[#155EEF]'>*</span></label>
                                    <input type="text" className="mt-1 p-2 border border-gray-300 rounded w-full" placeholder="Last name" />
                                </div>
                            </div>
                            <div>

                                <label className="block">Username <span className='text-[#155EEF]'>*</span></label>
