...
const ProjectSideAssociation = () => {
  ...
  const fetchPendingRequestFromMentorToProject = async () => {
    try {
      const result = await actor.get_all_offers_which_are_pending_for_project(
        projectId
      );
      console.log(
        `result-in-get_all_offers_which_are_pending_for_project`,
        result
      );
      setData(result);
    } catch (error) {
      console.log(
        `error-in-get_all_offers_which_are_pending_for_project`,
        error
      );
      setData([]);
    }
  ...
  const fetchApprovedRequestFromMentorToProject = async () => {
    try {
      const result =
        await actor.get_all_requests_which_got_accepted_for_project(projectId);
      console.log(
        `result-in-get_all_requests_which_got_accepted_for_project`,
        result
      );
      setData(result);
    } catch (error) {
      console.log(
        `error-in-get_all_requests_which_got_accepted_for_project`,
        error
      );
      setData([]);
    }
  ...
  const fetchDeclinedRequestFromMentorToProject = async () => {
    try {
      const result =
        await actor.get_all_requests_which_got_declined_for_project(projectId);
      console.log(
        `result-in-get_all_requests_which_got_declined_for_project`,
        result
      );
      setData(result);
    } catch (error) {
      console.log(
        `error-in-get_all_requests_which_got_declined_for_project`,
        error
      );
      setData([]);
    }
  ...
  const fetchSelfRejectedRequestFromMentorToProject = async () => {
    try {
      const result =
        await actor.get_all_requests_which_got_self_declined_for_project(
          projectId
        );
      console.log(
        `result-in-get_all_requests_which_got_self_declined_for_project`,
        result
      );
      setData(result);
    } catch (error) {
      console.log(
        `error-in-get_all_requests_which_got_self_declined_for_project`,
        error
      );
      setData([]);
    }
  ...
  const handleAcceptMentorOffer = async ({ message }) => {
    ...
    try {
      const result = await actor.accept_offer_of_mentor(
        offerId,
        message,
        projectId
      );
  ...
  const handleDeclineMentorOffer = async ({ message }) => {
    setIsSubmitting(true);
    try {
      const result = await actor.decline_offer_of_mentor(
        offerId,
        message,
        projectId
      );
  ...
  const fetchPendingRequestFromProjectToInvestor = async () => {
    try {
      const result = await actor.get_pending_offers_received_from_investor(
        projectId
      );
      console.log(
        `result-in-get_pending_offers_received_from_investor`,
        result
      );
      setData(result);
    } catch (error) {
  ...
  const fetchApprovedRequestFromProjectToInvestor = async () => {
    try {
      const result = await actor.get_accepted_request_of_project_by_investor(
        projectId
      );
      console.log(
        `result-in-get_accepted_request_of_project_by_investor`,
        result
      );
      setData(result);
    } catch (error) {
      console.log(
        `error-in-get_accepted_request_of_project_by_investor`,
        error
      );
      setData([]);
    }
  ...
  const fetchDeclinedRequestFromProjectToInvestor = async () => {
    try {
      const result = await actor.get_declined_request_of_project_by_investor(
        projectId
      );
      console.log(
        `result-in-get_declined_request_of_project_by_investor`,
        result
      );
      setData(result);
    } catch (error) {
      console.log(
        `error-in-get_declined_request_of_project_by_investor`,
        error
      );
      setData([]);
    }
  ...
  const fetchSelfRejectedRequestFromProjectToInvestor = async () => {
    try {
      const result = await actor.get_self_declined_requests_of_project(
        projectId
      );
      console.log(`result-in-get_self_declined_requests_for_project`, result);
      setData(result);
  ...
  const handleInvestorSelfReject = async (offer_id) => {
    try {
      const result = await actor.self_decline_request_for_project(
        offer_id,
        projectId
      );
  ...
  const fetchPendingRequestFromInvestorToProject = async () => {
    try {
      const result =
        await actor.get_all_offers_which_are_pending_for_project_from_investor(
          projectId
        );
      console.log(
        `result-in-get_all_offers_which_are_pending_for_project_from_investor`,
        result
      );
      setData(result);
    } catch (error) {
      console.log(
        `error-in-get_all_offers_which_are_pending_for_project_from_investor`,
        error
      );
      setData([]);
    }
  ...
  const fetchApprovedRequestFromInvestorToProject = async () => {
    try {
      const result =
        await actor.get_all_requests_which_got_accepted_by_project_of_investor(
          projectId
        );
      console.log(
        `result-in-get_all_requests_which_got_accepted_by_project_of_investor`,
        result
      );
      setData(result);
    } catch (error) {
      console.log(
        `error-in-get_all_requests_which_got_accepted_by_project_of_investor`,
        error
      );
      setData([]);
    }
  ...
  const fetchDeclinedRequestFromInvestorToProject = async () => {
    try {
      const result =
        await actor.get_all_requests_which_got_declined_by_project_of_investor(
          projectId
        );
      console.log(
        `result-in-get_all_requests_which_got_declined_by_project_of_investor`,
        result
      );
      setData(result);
    } catch (error) {
      console.log(
        `error-in-get_all_requests_which_got_declined_by_project_of_investor`,
        error
      );
      setData([]);
    }
  ...
  const fetchSelfRejectedRequestFromInvestorToProject = async () => {
    try {
      const result =
        await actor.get_all_requests_which_got_self_declined_by_investor(
          projectId
        );
      console.log(
        `result-in-get_all_requests_which_got_self_declined_by_investor`,
        result
      );
      setData(result);
    } catch (error) {
      console.log(
        `error-in-get_all_requests_which_got_self_declined_by_investor`,
        error
      );
      setData([]);
    }
  ...
  const handleAcceptInvestorOffer = async ({ message }) => {
    setIsSubmitting(true);
    try {
      const result = await actor.accept_offer_of_investor(
        offerId,
        message,
        projectId
      );
  ...
  const handleDeclineInvestorOffer = async ({ message }) => {
    setIsSubmitting(true);
    try {
      const result = await actor.decline_offer_of_investor(
        offerId,
        message,
        projectId
      );
    ...
    <div className="font-fontUse flex flex-col items-center w-full h-fit px-[5%] lg1:px-[4%] py-[4%] md:pt-0">
      <div className="mb-4 flex flex-row justify-between items-end w-full">
        ...
        <div className="text-sm text-center text-[#737373] mt-2">
          <ul className="hidden md1:flex flex-wrap -mb-px text-[10px] ss2:text-[10.5px] ss3:text-[11px]  cursor-pointer">
        ...
        {isPopupOpen && (
          <div className="absolute ss2:w-[250px] top-52 right-16 bg-white shadow-xl rounded-lg border border-gray-300 p-4 z-50">
      ...
      <div className="text-sm text-center text-[#737373] mt-2">
        <ul className="md1:hidden flex flex-wrap -mb-px text-[10px] ss2:text-[10.5px] ss3:text-[11px]  cursor-pointer">
          {headerData.map((header, index) => (
            <li key={index} className="me-6 relative group">
              <button
                className={getTabClassName(header?.id)}
          ...
          data.map((val, index) => {
            ...
            switch (activeTab) {
              case "pending":
                switch (selectedStatus) {
                  case "to-mentor":
                    img = val?.mentor_image[0]
                      ? uint8ArrayToBase64(val?.mentor_image[0])
                      : "";
                    name = val?.mentor_name ?? "";
                    date = val?.time_of_request
                      ? formatFullDateFromBigInt(val?.time_of_request)
                      : "";
                    msg = val?.offer_i_have_written ?? "";
                    offer_id = val?.offer_id ?? "";
                    break;
                  case "from-mentor":
                    img = val?.mentor_info?.mentor_image
                      ? uint8ArrayToBase64(val?.mentor_info?.mentor_image)
                      : "";
                    ...
                    break;
                  case "to-investor":
                    img = val?.investor_image[0]
                      ? uint8ArrayToBase64(val?.investor_image[0])
                      : "";
                    ...
                    break;
                  case "from-investor":
                    img = val?.investor_info?.investor_image
                      ? uint8ArrayToBase64(val?.investor_info?.investor_image)
                      : "";
              ...
              case "self-reject":
                switch (selectedStatus) {
                  case "to-mentor":
                    ...
                    msg = val?.offer_i_have_written ?? "";
                    offer_id = val?.offer_id ?? "";
                    self_decln = val?.self_declined_at
                      ? formatFullDateFromBigInt(val?.self_declined_at)
                      : "";
                    break;
                  case "from-mentor":
                    img = val?.mentor_info?.mentor_image
                        ...
                        <div className="flex gap-4">
                          <div>
                            <button
                              onClick={() =>
                                navigate(
                                  viewMentorOrInvestorProfileHanlder(val)
                                )
                              }
                          ...
                          {activeTab !== "pending" ? (
                              ...
                              <button
                                onClick={() => {
                                  selectedStatus.endsWith("mentor")
                                    ? handleMentorSelfReject(offer_id)
                                    : handleInvestorSelfReject(offer_id);
                                }}
                            ...
                            <>
                              ...
                              <div>
                                <button
                                  onClick={() =>
                                    handleMentorAcceptModalOpenHandler(offer_id)
                                  }
                                  className="capitalize border-2 font-semibold bg-blue-900 border-blue-900 text-white px-2 py-1 rounded-md  hover:text-blue-900 hover:bg-white"
                                >
                                  approve
