...
const MentorEdit = () => {
  ...
  const [mentorValue,setMentorValue]=useState(defaultValues);
  ...
  return (
    <div ref={editableRef} className=" bg-white"> 
       ...
       <div className="my-1 relative group hover:bg-slate-50 rounded p-1 mb-1">
          ...
          <label className="block mb-2 text-xs font-semibold text-gray-500">ICP HUB YOU WILL LIKE TO BE ASSOCIATED  </label>
          {edit.preferedIcpHub ? 
                  <div className="">
                    <select
               ...
               <span>{mentorValue.preferred_icp_hub} </span>
             </div> }
       </div>
       ...
       <div className="my-1 relative group hover:bg-slate-50 rounded p-1 mb-1">
        ...
        <label className="block mb-2 text-xs font-semibold text-gray-500"> DO YOU MENTOR MULTIPLE ECOSYSTEMS </label>
        {edit.multipleEcosystem ? (
          ...
          <div className="flex justify-between items-center cursor-pointer p-1">
            <span>{mentorValue.multi_chain}</span>
          </div>
        )}
      </div>
      ...
      <div className="relative group hover:bg-slate-50 rounded p-1 mb-2">
          ...
          <label className="block mb-2 text-xs font-semibold text-gray-500">CATEGORIES OF MENTORING SERVICES</label>
          {edit.mentorCategory ? 
                  <div className="">
                   <ReactSelect
                    isMulti
               ...
               : <div className="flex justify-between items-center cursor-pointer p-1">
               <span>{mentorValue.category_of_mentoring_service} </span>
             </div> }
       </div>
       ...
       <div className="my-1 relative group hover:bg-slate-50 rounded p-1 mb-2">
        ...
        <label className="block mb-2 text-xs font-semibold text-gray-500">ARE YOU ICP HUB/SPOKE </label>
        {edit.icpHubOrSpoke ? (
          <div>
            <select
          ...
          <div className="flex justify-between items-center cursor-pointer p-1">
            <span>{mentorValue.icp_hub_or_spoke} </span>
          </div>
        )}
      </div>
      ...
      <div className="my-1 relative group hover:bg-slate-50 rounded p-1 mb-2">
        ...
        <label className="block mb-2 text-xs font-semibold text-gray-500">WEBSITE LINK</label>
        {edit.websiteLink ? (
          <div>
            <input
          ...
          <div className="flex justify-between items-center cursor-pointer p-1">
            <span>{mentorValue.mentor_website_url} </span>
          </div>
        )}
      </div>
      ...
      <div className="my-1 relative group hover:bg-slate-50 rounded p-1 mb-2">
        ...
        <label className="block mb-2 text-xs font-semibold text-gray-500">YEARS OF MENTORING  <span className="text-red-500 ml-2">*</span> </label>
        {edit.mentoringYears ? (
          <div>
            <input
          ...
          <div className="flex justify-between items-center cursor-pointer p-1">
            <span>{mentorValue.years_of_mentoring} </span>
          </div>
        )}
      </div>
      ...
      <div className="my-1 relative group hover:bg-slate-50 rounded p-1 mb-2">
        ...
        <label className="block mb-2 text-xs font-semibold text-gray-500">LINKEDIN LINK  <span className="text-red-500 ml-2">*</span></label>
        {edit.linkedinLink ? (
          <div>
            <input
          ...
          <div className="flex justify-between items-center cursor-pointer p-1">
            <span>{mentorValue.mentor_linkedin_url} </span>
          </div>
        )}
      </div>
      <div className="flex ">
