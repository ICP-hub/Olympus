...
const MentorsProfile = () => {
  ...
  let preferred_icp_hub = mentorProfileData?.preferred_icp_hub?.[0];
  ...
  return (
    <div className="px-[4%] w-full bg-gray-100 overflow-y-scroll font-fontUse">
        ...
        <div className="text-[#737373] text-xs my-4 grid sm:grid-cols-2">
          <div className="sm:col">
            ...
            <div className="flex items-center my-2">
              ...
              >
                <path
                  d="M4.17855 2.4375C2.94687 2.47445 2.21253 2.61154 1.70441 3.12013C1.00879 3.8164 1.00879 4.93703 1.00879 7.17829L1.00879 12.3289C1.00879 14.5702 1.00879 15.6908 1.70441 16.3871C2.40003 17.0833 3.51962 17.0833 5.75879 17.0833L9.71712 17.0833C11.9563 17.0833 13.0759 17.0833 13.7715 16.3871C14.4671 15.6908 14.4671 14.5702 14.4671 12.3289V7.17829C14.4671 4.93703 14.4671 3.8164 13.7715 3.12013C13.2634 2.61154 12.529 2.47445 11.2974 2.4375"
                  stroke="#2A353D"
                />
                <path
              ...
              <h6 className="ml-2">
                Expertise in {categoryOfMentoringService}
              </h6>
            </div>
            <div className="flex items-center my-2">
              <svg
      ...
      <div>
        ...
        {multiChain && multiChain[0] && multiChain[0].trim() !== "" && (
          <div className="border-b border-[#DCDCDC] my-5 pb-12 p-5">
            <h4 className="text-xl font-[950]">
              Ecosystems {mentorName?.split(" ")[0]} has worked with
            </h4>
        ...
        {id ===
          "nq6zx-w3cl3-cwulr-uejdh-hw4u4-qvmgx-4hryz-zqkyq-dnl7a-dovtu-sqe" && (
          <div className="border-b border-[#DCDCDC] my-5 pb-12 p-5">
            <h4 className="text-xl font-[950]">
              What projects say about {mentorName?.split(" ")[0]}
            </h4>
                      ...
                      <div className="flex-1 px-1 py-2 sm:px-2 sm:py-4 leading-relaxed text-[#737373] text-base">
                        ...
                        <div className="text-sm sm:text-base text-black">
                          ...
                          <p className="line-clamp-2 sm:line-clamp-none">
                            Under your guidance, our project not only navigated
                            through challenging waters but thrived, exceeding
                            our most ambitious expectations. Your unwavering
                            support, insightful feedback, and the strategic
                            direction you provided were instrumental in our
                            success. Thank you for believing in us and our
                            vision, and for steering us towards excellence. Your
                            mentorship has left an indelible mark on both our
                            project and our personal growth.
                          </p>
                          {/* <p>
                          Upvote(21) Share{" "}
