...
export const CohortViewAllSkeleton = () => {
  return (
            < SkeletonTheme baseColor="#e3e3e3" highlightColor="#c8c8c873">
      <div className="block w-full sm:w-[40%] drop-shadow-xl rounded-lg bg-white mb-8  ">
        <div className="w-full relative">
          <Skeleton height={170} width="100%" className="sm:h-48 lg:h-56 pt-1" />
