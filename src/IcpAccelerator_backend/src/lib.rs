...
mod tests {
    ...
    fn save_candid() {
        ...
        write(dir.join("C:/Users/user/OneDrive/Desktop/Company/ICPAccelerator/src/IcpAccelerator_backend/IcpAccelerator_backend.did"), export_candid()).expect("Write failed.");
    }
}
