...
const MENTOR_DECLINED_REQUEST_MEMORY_ID: MemoryId = MemoryId::new(12);

type MentorAnnouncement = StableBTreeMap<StoredPrincipal, Candid<Vec<MAnnouncements>>, VMem>;
const MENTOR_ANNOUNCEMENTS_MEMORY_ID: MemoryId = MemoryId::new(13);

type VentureCapitalistStorage =
StableBTreeMap<StoredPrincipal, Candid<VentureCapitalistInternal>, VMem>;
const VENTURE_CAPITALIST_STORAGE_MEMORY_ID: MemoryId = MemoryId::new(14);
...
const MENTOR_INDIVIDUAL_RATINGS_MEMORY_ID: MemoryId = MemoryId::new(15);
const VC_INDIVIDUAL_RATINGS_MEMORY_ID: MemoryId = MemoryId::new(16);
const MENTOR_AVERAGE_RATING_STORAGE_MEMORY_ID: MemoryId = MemoryId::new(17);
const VC_AVERAGE_RATING_STORAGE_MEMORY_ID: MemoryId = MemoryId::new(18);

type VentureCapitalistDeclinedRequest =
StableBTreeMap<StoredPrincipal, Candid<VentureCapitalistInternal>, VMem>;
const VENTURE_CAPITALIST_DECLINED_REQUEST_MEMORY_ID: MemoryId = MemoryId::new(19);

type VentureCapitalistAnnouncement =
StableBTreeMap<StoredPrincipal, Candid<Vec<VAnnouncements>>, VMem>;
const VC_ANNOUNCEMENTS_MEMORY_ID: MemoryId = MemoryId::new(20);
...
const OFFERS_OFFERED_BY_ME_MEMORY_ID: MemoryId = MemoryId::new(21);
const INVESTOR_ALERTS_MEMORY_ID: MemoryId = MemoryId::new(22);
type ProjectAccessNotification = StableBTreeMap<String, Candid<Vec<ProjectNotification>>, VMem>;
const PROJECT_ACCESS_NOTIFICATIONS_MEMORY_ID: MemoryId = MemoryId::new(23);

type ProjectStorage = StableBTreeMap<StoredPrincipal, Candid<Vec<ProjectInfoInternal>>, VMem>;
const PROJECT_STORAGE_MEMORY_ID: MemoryId = MemoryId::new(24);


//rating.rs module

const RATING_SYSTEM_MEMORY_ID: MemoryId = MemoryId::new(25);
const LAST_RATING_TIMESTAMPS_MEMORY_ID: MemoryId = MemoryId::new(26);
const AVERAGE_STORAGE_MEMORY_ID: MemoryId = MemoryId::new(27);


type ProjectAnnouncement =
StableBTreeMap<StoredPrincipal, Candid<Vec<AnnouncementsInternal>>, VMem>;
const PROJECT_ANNOUNCEMENT_MEMORY_ID: MemoryId = MemoryId::new(28);
...
const MY_SENT_NOTIFICATIONS_MEMORY_ID: MemoryId = MemoryId::new(29);
const MENTOR_ALERTS_MEMORY_ID: MemoryId = MemoryId::new(30);
...
const MY_SENT_NOTIFICATIONS_PROJECT_MEMORY_ID: MemoryId = MemoryId::new(31);
const PROJECT_ALERTS_MEMORY_ID: MemoryId = MemoryId::new(32);
type ProjectAwaitsResponse = StableBTreeMap<StoredPrincipal, Candid<ProjectInfoInternal>, VMem>;
const PROJECT_AWAITS_RESPONSE_MEMORY_ID: MemoryId = MemoryId::new(33);

type PostJob = StableBTreeMap<StoredPrincipal, Candid<Vec<JobsInternal>>, VMem>;
const POST_JOB_MEMORY_ID: MemoryId = MemoryId::new(34);


type MoneyAccess = StableBTreeMap<String, Candid<Vec<Principal>>, VMem>;
const MONEY_ACCESS_MEMORY_ID: MemoryId = MemoryId::new(35);

//admin.rs

type PrivateDocsAccess = StableBTreeMap<String, Candid<Vec<Principal>>, VMem>;
const PRIVATE_DOCS_ACCESS_MEMORY_ID: MemoryId = MemoryId::new(36);

type ProjectRating = StableBTreeMap<String, Candid<Vec<(Principal, ProjectReview)>>, VMem>;
const PROJECT_RATING_MEMORY_ID: MemoryId = MemoryId::new(37);

type MoneyAccessRequest = StableBTreeMap<StoredPrincipal, Candid<Vec<AccessRequest>>, VMem>;
const MONEY_ACCESS_REQUEST_MEMORY_ID: MemoryId = MemoryId::new(38);

type PrivateDocsAccessRequest = StableBTreeMap<StoredPrincipal, Candid<Vec<AccessRequest>>, VMem>;
const PRIVATE_DOCS_ACCESS_REQUEST_MEMORY_ID: MemoryId = MemoryId::new(39);

type ProjectAssociatedWithMentor =
    StableBTreeMap<StoredPrincipal, Candid<Vec<ProjectInfoInternal>>, VMem>;
const PROJECTS_ASSOCIATED_WITH_MENTOR_MEMORY_ID: MemoryId = MemoryId::new(40);
...
const PENDING_MENTOR_CONFIRMATION_TO_REJOIN_MEMORY_ID: MemoryId = MemoryId::new(47);


pub type AssetManager = StableCell<StoredPrincipal, VMem>;
const ASSET_CANISTER_STORAGE_MEMORY_ID: MemoryId = MemoryId::new(48);
