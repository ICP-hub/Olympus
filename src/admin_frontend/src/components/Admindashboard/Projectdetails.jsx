            ...
            <div className="px-2"> 
              ...
              <div className="md:flex block text-xs md:text-sm text-[#737373]">
                <div className='flex flex-row gap-4 '> 
                    <p className='text-[#737373] bg-gray-200 rounded-full px-2'>Infrastructure</p>
                    <p className='text-[#737373] bg-gray-200 rounded-full px-2'>Tooling</p>
                  </div>
              </div>
            </div>
            ...
            <p className='text-[#320099] font-bold'>View Rating</p>
              <div className='flex flex-row gap-6 flex-wrap items-center'>
                            ...
                            <div className='flex flex-col justify-center items-center gap-2'>
                              ...
                              <h1 className='font-bold text-black text-xl'>Overall Ratings</h1>
            ...
            <div className="p-8 flex flex-col items-center h-full relative z-10 w-full">
              <div className="flex flex-col w-full">
                ...
                <div className='mt-4 ml-8 text-[#737373] text-xl space-y-4 overflow-hidden '>
                  ...
                  <p className='flex flex-wrap relative '>The Student Side Dashboard provides students with access to the assigned tests and assessments created by their respective teachers. Students can log in to their accounts, view a list of available tests, and choose the tests they want to attempt. The dashboard allows them to navigate through the tests, answer questions, and submit their responses within the specified time limit.</p>
                  <p className='relative'>Upon completing a test, students can view their scores and performance summary. The platform provides immediate feedback, highlighting correct and incorrect answers, helping students identify areas that require improvement. They can also access their historical test results and track their progress over time.</p>

                  <p className='relative'>Additional Features: In addition to the core functionalities mentioned above, the website may include other features to enhance the learning experience. These may include:</p>
                  <p>1. Test Scheduling: The ability for teachers to schedule tests for specific dates and times, ensuring timely access for students.</p>
                  <p className='relative'>2. Announcements and Notifications: Teachers can share important announcements, updates, and reminders with students through the platform.</p>
                  <p className='relative'>3. Progress Tracking: A comprehensive progress tracking system that allows teachers and students to monitor performance over time.</p>
                </div>
                      ...
                      <div className='flex flex-col '>
                        ...
                        <div className="relative my-8 ml-24 flex flex-row  items-center  gap-2 sm:flex-wrap ">
                          ...
                          <div className="text-gray-600 ml-4">
                            {((sliderValues[sliderKeys[currentStep]] - 2) / 8 * 100).toFixed(0)} Level
                          </div>
                        </div>
