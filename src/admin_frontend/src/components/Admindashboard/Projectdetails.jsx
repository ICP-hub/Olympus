          ...
          <div className="relative w-full md:w-[950px] border-2 border-black overflow-hidden">
            ...
            <div className="p-8 flex flex-col items-center h-full relative z-10 w-full">
              <div className="flex flex-col w-full">
                    ...
                    <div className="flex flex-col bg-[#B9C0F2] relative w-full md:w-1/2 gap-4 rounded-md p-2 text-[#737373] h-[230px] mt-8 justify-between overflow-y-auto">
                      <div className="ml-4 mr-20 mt-4 font-serif font-bold">
                        <div className="flex flex-row justify-between space-x-2">
                          <p>Team Size</p>
                          <p className="font-extrabold items-center">0</p>
                        </div>
                        ...
                        <div className="flex flex-row justify-between mt-2 space-x-2">
                          <p>Referral</p>
                          <p className="font-extrabold items-center"></p>
                        </div>
                        <div className=" flex flex-row justify-between mt-2 space-x-2">
                          <p>Average Experience</p>
                          <p className="font-extrabold items-center">0</p>
                ...
                <div className="flex flex-wrap mt-4 ml-8 text-[#737373] text-xl  overflow-hidden">
                  {userData[0].params.dapp_link[0] && (
                    <div className="w-full md:w-1/2">
                      <p className="font-extrabold">Github</p>
                      <div className="absolute xl:lg:top-[500px] md:top-[700px] top-[700px] right-[-95px] flex bg-blue-100 w-[190.63px] h-[190px] border rounded-full"></div>
                      <p className="font-serif relative">
                        <a
                          target="_blank"
                  ...
                  <div className="w-full md:w-1/2 ">
                    <p className="font-extrabold relative">Long term Goal</p>
                    <p className="font-serif relative ">
                      {userData[0].params.long_term_goals}
                    </p>
                  </div>
                ...
                <div className="flex flex-wrap mt-4 ml-8 text-[#737373] text-xl overflow-hidden gap2">
                  <div className="w-full md:w-1/2">
                    <p className="font-extrabold">Project Elevator Pitch</p>
                    <p className="font-serif relative truncate">
                      <a
                        target="_blank"
                  ...
                  <div className="w-full md:w-1/2">
                    <div className="font-extrabold">Project website</div>
                    <p className="font-serif relative truncate text-blue-500 text-md">
                      <a
                        target="_blank"
                ...
                <div className="flex flex-wrap mt-4 ml-8 text-[#737373] text-xl overflow-hidden ">
                  <div className="w-full md:w-1/2 ">
                    ...
                    <p className="relative font-serif truncate">
                      <a
                        target="_blank"
