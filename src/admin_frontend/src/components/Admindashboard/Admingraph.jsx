    ...
    <div className='p-[4%] w-full h-auto'>
      ...
      <div className="flex flex-row w-full flex-wrap md:flex-nowrap px-[4%] py-[5%] h-[100px]  lg:mt-[-130px] gap-8  ">
        ...
        <div className="flex flex-col gap-4 ">
          <div className="rounded-lg flex justify-center items-center h-[80px] lg:md:w-[236px] w-[340px] bg-[#B9C0F2]  drop-shadow-xl border-2 cursor-pointer" onClick={()=>navigate("/notification")}>
            ...
            <div className="flex  flex-row items-center lg:justify-start justify-center font-bold text-lg text-black gap-8  object-cover">
              ...
              <p className="flex justify-start">Project</p>
              <p className="font-extrabold w-[59px] h-[62px] flex  text-2xl justify-center items-center">125</p>
            </div>
          </div>

          <div className="rounded-lg flex justify-center items-center flex-col h-[80px] lg:md:w-[236px] w-[340px] bg-[#B9C0F2]  drop-shadow-xl border-2  cursor-pointer" onClick={()=>navigate("/notification")}>
            <div className="flex  flex-row items-center justify-start font-bold text-lg text-black gap-8">
              <img src={hub} alt="founder" />
              <p className="flex justify-start">Mentor</p>
        ...
        <div className="flex flex-col gap-4">
          <div className="rounded-lg flex justify-center items-center h-[80px] lg:md:w-[236px] w-[340px] bg-[#B9C0F2]  drop-shadow-xl border-2 cursor-pointer  " onClick={()=>navigate("/notification")}>
            ...
            <div className="flex  flex-row items-center justify-start font-bold text-lg text-black gap-8">
              ...
              <p className="flex justify-start">Investor</p>
              <p className="font-extrabold w-[59px] h-[62px] flex  text-2xl justify-center items-center">125</p>
            </div>
          </div>
