...
import { typeOfProfileSliceHandlerRequest,  typeOfProfileSliceHandlerSuccess, typeOfProfileSliceHandlerFailure } from "../Reducers/getTypeOfProfile";
...
export function* typeOfProfileSaga() {
  yield takeLatest(typeOfProfileSliceHandlerRequest.type, fetchTypeOfProfileHandler);
}
