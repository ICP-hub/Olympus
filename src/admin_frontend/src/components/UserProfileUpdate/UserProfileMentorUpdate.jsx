  ...
  useEffect(() => {
   ...
   const onSubmitHandler = async (data) => {
    if (actor) {
      ...
      try {
          await actor.update_mentor_profile( principal, mentorData).then((result) => {
            if (result && result.includes("Mentor profile updated successfully")) {
                ...
                <div className="flex flex-col mb-2">
                  ...
                  <div className="flex space-x-2 items-center flex-row text-gray-600">
                    ...
                    {editMode ? (
                      ...
                      <>
                        {place}
                        <div className="underline ">{updatedData?.country}</div>
                      </>
                    )}
                  </div>
                </div>
