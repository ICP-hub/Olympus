...
const Projectprofile = lazy(()=> import ("./components/Admindashboard/Profile/Projectprofile"))
const Adminalluser = lazy(()=> import ("./components/Admindashboard/Adminalluser")) 
const Projectdetails= lazy(()=>import ("./components/Admindashboard/Projectdetails"))
